...
export const placeApi = {
  getAll: (organizationId) =>
    api.get("/places", { params: { organizationId } }),
...
export const analyticsApi = {
  getOrgOverview: (orgId, params) =>
    api.get(`/analytics/organization/${orgId}`, { params }),
  getPlaceAnalytics: (placeId, params) =>
    api.get(`/analytics/place/${placeId}`, { params }),
  getMachineAnalytics: (machineId, params) =>
    api.get(`/analytics/machine/${machineId}`, { params }),
